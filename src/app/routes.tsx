...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "pr-history", Component: OrdersPage },
      { path: "quote-history", Component: OrdersPage },
      { path: "po-history", Component: OrdersPage },
      ...
      { path: "admin/content",  Component: AdminDashboard },
      { path: "admin/pages",    Component: AdminDashboard },
