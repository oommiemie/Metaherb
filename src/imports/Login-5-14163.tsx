import svgPaths from "./svg-x54zs972pg";
...
import { imgSearch } from "./svg-fvqke";
...
export default function Login() {
  return (
    <div className="backdrop-blur-[8px] bg-[rgba(255,255,255,0.9)] content-stretch flex items-center justify-between px-[124px] py-[16px] relative size-full" data-name="login">
      <Frame1 />
