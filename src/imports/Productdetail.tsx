import svgPaths from "./svg-utgdbt0iug";
...
import imgEllipse2 from "figma:asset/02fc4d2560c804d8d3f2f8e525b1926bf3ef0ac2.png";
...
import imgEllipse3 from "figma:asset/f9c837257a7dc5d10d1ea92a733813c293a76a81.png";
...
import imgEllipse8 from "figma:asset/70017910a949817aa1c11716388ee64b40b2eafa.png";
import { imgSearch } from "./svg-68xrz";
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[24px] items-center justify-end min-h-px min-w-px relative">
      ...
      <div className="relative shrink-0 size-[42px]">
        <img alt="" className="absolute block max-w-none size-full" height="42" src={imgEllipse2} width="42" />
      </div>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="relative rounded-[16px] shrink-0 size-[450px]">
...
function BoltFill() {
  return (
    <div className="h-[21.978px] overflow-clip relative shrink-0 w-[14.121px]" data-name="bolt.fill 1">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.1211 21.9778">
        <g id="Group">
          <path d={svgPaths.p8fcf400} fill="var(--fill-0, black)" id="Vector" opacity="0" />
          <path d={svgPaths.p2f1523c0} fill="var(--fill-0, white)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function Frame97() {
  return (
    <div className="content-stretch flex gap-[10px] h-[33px] items-center py-[6px] relative shrink-0">
      <BoltFill />
      <div className="flex flex-col font-['IBM_Plex_Sans_Thai_Looped:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[20px] text-center text-white whitespace-nowrap">
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center py-[4px] relative rounded-[8px] shrink-0 w-[32px]" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.2) 100%), linear-gradient(rgb(230, 46, 5) 0%, rgb(188, 27, 6) 100%)" }}>
      <div className="flex flex-col font-['IBM_Plex_Sans_Thai_Looped:SemiBold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
...
function Frame14() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <Frame11 />
      <div className="flex flex-col font-['IBM_Plex_Sans_Thai_Looped:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">
...
function Frame17() {
  return (
    <div className="bg-[#e62e05] relative rounded-tl-[16px] rounded-tr-[16px] shrink-0 w-full">
...
function Frame27() {
  return (
    <div className="bg-[#e62e05] content-stretch flex items-center justify-center px-[16px] py-[4px] relative rounded-[100px] shrink-0">
      <div className="flex flex-col font-['IBM_Plex_Sans_Thai_Looped:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">
        <p className="leading-[normal]">ลด 40%</p>
      </div>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[10px] items-center p-[10px] relative w-full">
          <div className="flex flex-col font-['IBM_Plex_Sans_Thai_Looped:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#bc1b06] text-[24px] text-center whitespace-nowrap">
            <p className="leading-[normal]">฿ 0.00</p>
          </div>
          <div className="flex flex-col font-['IBM_Plex_Sans_Thai_Looped:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#a3a3a3] text-[16px] text-center whitespace-nowrap">
            <p className="[text-decoration-skip-ink:none] decoration-solid leading-[normal] line-through">฿ 0.00</p>
          </div>
          <Frame27 />
        </div>
      </div>
...
function Frame74() {
  return (
    <div className="content-stretch flex flex-col items-start relative rounded-[16px] shrink-0 w-full" style={{ backgroundImage: "linear-gradient(90deg, rgb(255, 244, 237) 0%, rgb(255, 244, 237) 100%), linear-gradient(90deg, rgb(230, 46, 5) 0%, rgb(230, 46, 5) 100%)" }}>
      <Frame17 />
      <Frame75 />
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <div className="relative shrink-0 size-[70px]">
        <img alt="" className="absolute block max-w-none size-full" height="70" src={imgEllipse3} width="70" />
      </div>
      <Frame139 />
    </div>
  );
...
function Frame9() {
  return (
    <div className="bg-[#fafafa] relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[16px] items-start px-[124px] py-[16px] relative w-full">
...
function Frame133() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[100px] shrink-0 size-[20px]">
      <div className="flex-[1_0_0] min-h-px min-w-px relative w-full">
        <img alt="" className="absolute block max-w-none size-full" height="20" src={imgEllipse8} width="20" />
      </div>
    </div>
  );
}
...
export default function Productdetail() {
  return (
    <div className="content-stretch flex flex-col items-start relative size-full" data-name="Productdetail">
      <Frame33 />
      <Frame9 />
