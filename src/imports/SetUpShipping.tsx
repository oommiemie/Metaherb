import svgPaths from "./svg-2owgaebdqu";
...
function Frame5() {
  return (
    <div className="col-1 content-stretch flex flex-col gap-[8px] h-[79px] items-start justify-self-stretch relative row-1 shrink-0">
...
function Frame25() {
  return (
    <div className="col-2 content-stretch flex flex-col h-[79px] items-start justify-self-stretch relative row-1 shrink-0">
      <Frame6 />
    </div>
  );
}
